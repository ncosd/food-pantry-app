...
themer.setTheme(themer.getPreferredTheme())
  ...
  <div class="d-flex align-items-center">
    <div class="d-flex align-items-center dropdown color-modes">
      ...
      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bd-theme" style="--bs-dropdown-min-width: 8rem;">
        <li>
          <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="light" @click="toggleTheme('light')">
        ...
        <li>
          <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="dark" @click="toggleTheme('dark')">
        ...
        <li>
          <button type="button" class="dropdown-item d-flex align-items-center active" data-bs-theme-value="auto" @click="toggleTheme('auto')">
