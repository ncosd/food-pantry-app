...
<div class="container">
  ...
  <ul>
    ...
    <li><a href="https://github.com/ncosd/food-pantry-app/issues/309">#309</a> Add Pickup date/window to admin order page.</li>
    <li><a href="https://github.com/ncosd/food-pantry-app/issues/301">#301</a> Admin can create order form for guests.</li>
  </ul>
